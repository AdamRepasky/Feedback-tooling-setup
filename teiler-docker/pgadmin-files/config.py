...
OAUTH2_CONFIG = [
{
	...
	# Oauth secret
	'OAUTH2_CLIENT_SECRET': 'jtVMzFOzQv3hnYfrDDeHD3FmYvUaJmoT',

	# URL to generate a token,
	# Ex: https://github.com/login/oauth/access_token
	#'OAUTH2_TOKEN_URL': 'http://localhost:8380/auth/realms/test-orchestrator/protocol/openid-connect/token',
	'OAUTH2_TOKEN_URL': 'http://login:8080/auth/realms/teiler-ui/protocol/openid-connect/token',


	# URL is used for authentication,
	# Ex: https://github.com/login/oauth/authorize
	'OAUTH2_AUTHORIZATION_URL': 'http://localhost:8380/auth/realms/teiler-ui/protocol/openid-connect/auth',
	#'OAUTH2_AUTHORIZATION_URL': 'http://login:8080/auth/realms/test-orchestrator/protocol/openid-connect/auth',

	# Oauth base url, ex: https://api.github.com/
	#'OAUTH2_API_BASE_URL': 'http://localhost:8380/auth/',
	#'OAUTH2_API_BASE_URL': 'http://login:8080/auth/',
	'OAUTH2_API_BASE_URL': None,

	# Name of the Endpoint, ex: user
	#'OAUTH2_USERINFO_ENDPOINT': 'http://localhost:8380/auth/realms/test-orchestrator/protocol/openid-connect/userinfo',
	'OAUTH2_USERINFO_ENDPOINT': 'http://login:8080/auth/realms/teiler-ui/protocol/openid-connect/userinfo',

	# Oauth scope, ex: 'openid email profile'
	# Note that an 'email' claim is required in the resulting profile
	'OAUTH2_SCOPE': 'openid profile roles',
